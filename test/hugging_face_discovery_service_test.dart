...
void main() {
  group('Hugging Face discovery service', () {
    ...
    test('searches a limited recent GGUF page and excludes restrictions',
      ...
      final results = await service.searchPublicGgufRepositories(limit: 12);
    ...
    test('parses exact repository, license, upstream, and blob metadata',
      ...
      final metadata =
          await service.getRepositoryMetadata('Publisher/Example-GGUF');
    ...
    test('rejects an invalid repository identifier before requesting',
        () async {
      int requests = 0;
      final HuggingFaceDiscoveryService service = HuggingFaceDiscoveryService(
        fetchJson: (Uri uri) async {
